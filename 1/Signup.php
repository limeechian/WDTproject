...
if(isset($_POST['btnSignup'])) {
    ...
    $query = "INSERT INTO `customer` (`Customer_Name`, `Customer_Email`, `Customer_Phone_Number`, `Customer_Password`) VALUES ('$username', '$email', '$phone', '$password')";
...
<body>
    <div id="wrapper">
        <form action="#" method="post">
            ...
            <button type="reset" name="btnReset" value="Cancel">Cancel</button>
            <br><br>
