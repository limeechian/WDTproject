...
<head>
  ...
  <title>Organic2U</title>  <!-- BOOTSTRAP CSS LINK (for the website appearance)  -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <li class="nav-item">
    <?php
      ...
      <?php
      }  else if (!empty($_SESSION['CompID'])){
      ?>
      <li><a class="nav-link" href="Seller Profile Page.php"><?php echo $_SESSION['CompName']; ?> </a></li>
      <a class="nav-link" href="Logout.php">Logout</a>
...
<div class="chat-popup" id="myChat">
  <form action="#" class="Chat-container" method="POST">
    <h1>Chat</h1>
